...
export default class TextAreaAction extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openPalette: false,
  ...
  render() {
    const handleChange = (type, event) => {
      ...
      } else if (type === "rowsmax") {
        clone.rowsmax = newname;
      } else if (type === "rowsmin") {
        clone.rowsmin = newname;
      } else if (type === "font") {
        clone.font = newname;
      } else if (type === "alignment") {
        clone.alignment = newname;
      } else if (type === "inputtype") {
        clone.inputType = newname;
    ...
    return (
      <div>
        ...
        <ListItem>
          <TextField
            label="Minimum no. of rows"
            value={this.props.ActionbarData.rowsmin}
            type="number"
            onChange={(event) => {
              handleChange("rowsmin", event);
            }}
          ></TextField>
        </ListItem>
        <ListItem>
          <TextField
            ...
            value={this.props.ActionbarData.rowsmax}
            type="number"
            onChange={(event) => {
              handleChange("rowsmax", event);
            }}
          ></TextField>
        </ListItem>
        <ListItem>

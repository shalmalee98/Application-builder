...
export default class LinkAction extends React.Component {
  ...
  render() {
    const handleChange = (type, event) => {
      ...
      if (type === "linkname") {
        clone.linkname = newname;
      } else if (type === "link") {
        clone.link = newname;
      } else if (type === "title") {
        clone.title = newname;
      } else if (type === "target") {
        clone.target = newname;
    ...
    return (
      <div>
        <ListItem>
          <TextField
            label="Label"
            value={this.props.ActionbarData.linkname}
            onChange={(event) => {
              handleChange("linkname", event);
            }}
          ></TextField>
        </ListItem>
        <ListItem>
          <TextField
            label="href"
            value={this.props.ActionbarData.link}
            onChange={(event) => {
        ...
        <ListItem>
          <TextField
            label="Tool Tip"
            value={this.props.ActionbarData.title}
            onChange={(event) => {
        ...
        <ListItem>
          <FormControl fullWidth>
            ...
            <Select
              ...
              value={this.props.ActionbarData.target}
              onChange={(event) => {
                handleChange("target", event);
              }}
            >
              <MenuItem value="_self">Current Tab</MenuItem>
